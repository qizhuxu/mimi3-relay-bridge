...
基于 [wkeqin/mimi3](https://github.com/wkeqin/mimi3)，桥接部分已替换为经过安全审计的 [mimo-claw-relay](https://github.com/qizhuxu/mimo-claw-relay) skill。
...
- 多账号轮询负载均衡
- 流式响应支持
- 集成 [mimo-claw-relay](https://github.com/qizhuxu/mimo-claw-relay) 安全审计桥接
...
桥接客户端已集成 [mimo-claw-relay](https://github.com/qizhuxu/mimo-claw-relay) skill（已通过安全审计）：

```bash
# 安装 mimo-claw-relay skill
git clone https://github.com/qizhuxu/mimo-claw-relay.git ~/.openclaw/skills/mimo-claw-relay
...
> 🔒 mimo-claw-relay 已通过安全审计，审计声明见 [SKILL.md](https://github.com/qizhuxu/mimo-claw-relay/blob/main/SKILL.md)
...
[wkeqin/mimi3](https://github.com/wkeqin/mimi3) | [mimo-claw-relay](https://github.com/qizhuxu/mimo-claw-relay)
